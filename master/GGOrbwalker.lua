...
if
	GGUpdate:New({
		...
		scriptUrl = "https://raw.githubusercontent.com/norivanoliveira/GG/master/" .. __name__ .. ".lua",
		versionPath = SCRIPT_PATH .. __name__ .. ".version",
		versionUrl = "https://raw.githubusercontent.com/norivanoliveira/GG/master/" .. __name__ .. ".version",
	}):CanUpdate()
then
	return
end

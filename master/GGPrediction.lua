...
Callback.Add("Load", function()
	GGUpdate:New({
		...
		scriptUrl = "https://raw.githubusercontent.com/norivanoliveira/GG/master/" .. Name .. ".lua",
		versionPath = COMMON_PATH .. Name .. ".version",
		versionUrl = "https://raw.githubusercontent.com/norivanoliveira/GG/master/" .. Name .. ".version",
	})
end)
